...
interface PartnerTableProps {
  ...
  onPartnerTypeFilterChange?: (value: string) => void;
  statusFilter?: string;
...
export function PartnerTable({
  ...
  const filteredData = data.filter((row) => {
    ...
    const matchesType = !partnerTypeFilter || partnerTypeFilter === 'all' || row.partnerType === partnerTypeFilter;
  ...
  const renderCellContent = (row: any, columnKey: string) => {
    ...
    if (columnKey === 'partnerType') {
      ...
      return (
        <Badge variant={typeColors[row.partnerType] || 'outline'}>
          {t(row.partnerType.toLowerCase())}
        </Badge>
      );
    }
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-4">
        ...
        <Select
          ...
          onValueChange={onPartnerTypeFilterChange}
        >
          <SelectTrigger className="w-[180px]">
            <SelectValue placeholder={t('partner_type')} />
          </SelectTrigger>
          <SelectContent>
              ...
              <TableRow>
                ...
                >
                  {searchTerm || partnerTypeFilter !== 'all' || statusFilter !== 'all' 
                    ? t('no_matching_partner') 
                    : t('no_partner_message')}
                </TableCell>
              </TableRow>
            ) : (
